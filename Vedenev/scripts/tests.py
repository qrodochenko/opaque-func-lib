def generator1(n, name, trig, var, code, dom, arg):
    s="""
    [TestClass]
    public class Ctest_L00_{0}_1_{2}
    {{
        double persicion = 0.000000000000001;
        [TestMethod]
        public void test_L00_{0}_1_{2}_2()
        {{
        ...
        [TestMethod]
        public void test_L00_{0}_1_{2}_2_in()
        {{
            Assert.IsTrue(CL00_{0}_1_{2}_in.Body() == "{5}", "Интервалы не совпадают");
        }}
