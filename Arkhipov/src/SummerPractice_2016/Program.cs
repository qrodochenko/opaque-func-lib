    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            System.IO.StreamWriter file86 = new System.IO.StreamWriter(@"..\\..\\..\\..\\csv\L00_86_1_th.csv");
        ...
        static void makeErrorPlot(string source_csv_file_name)
        {
            ...
            while (!parser.EndOfData)
            {
                ...
                /* Выдает ошибку:
                Необработанное исключение: System.OverflowException: Значение было недопустимо малым или недопустимо большим для Decimal.
                ...
                if (fields[2] == "РЅРµВ С‡РёСЃР»Рѕ") { fields[2] = "0"; }
                if (fields[0] == "РЅРµВ С‡РёСЃР»Рѕ") { fields[0] = "0"; }
                if (fields[2] == "в€ћ") { fields[2] = "NaN"; }
                if (fields[0] == "в€ћ") { fields[0] = "NaN"; }
            ...
            errorChart.Series["absolute_error"].BorderWidth = 3;
