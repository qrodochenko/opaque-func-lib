...
namespace OpaqueFunctions
{
...
#if DEBUG
            if (Math.Abs(thX * thX) <= double.Epsilon)
                throw new Exception("Деление на ноль");
#endif
    ...
    /// (w, 0) (0, w)
    /// https://www.wolframalpha.com/input/?i=th(x)+%3D+0
    /// </summary>
    ...
    public static class CL00_91_2_th_sh_ch
    {
        public static double L00_91_2_th_sh_ch(double angle, double angle2)
        {
            ...
            chY = Math.Cosh(angle2);
#if DEBUG
            if (Math.Abs(chX) <= double.Epsilon || Math.Abs(chY) <= double.Epsilon)
                throw new Exception("Деление на ноль");
#endif
    ...
    public static class CL00_93_2_cth_sh
    {
        public static double L00_93_2_cth_sh(double angle, double angle2)
        {
#if DEBUG
            if (angle <= 0 || angle2 <= 0)
                throw new Exception("Аргумент вне зоны определения");
#endif
            ...
            shY = Math.Sinh(angle2);
#if DEBUG
            if (Math.Abs(shX) <= double.Epsilon || Math.Abs(shY) <= double.Epsilon)
                throw new Exception("Деление на ноль");
#endif
    ...
    /// На самом деле, функция определена везде, кроме х=0 и у=0, но формат требует такой вывод.
    /// </summary>
    /// <returns>string</returns>
    [OpaqueFunction()]
    ...
    public static class CL00_98_2_sh_ch
    {
        ...
        {
#if DEBUG
            if (Math.Abs(angle) > 10 || Math.Abs(angle2) > 10)
                throw new Exception("При таких аргументах значение функции не ноль. см функцию с областью определения");
#endif
    ...
    /// Данная функция не тождественный ноль. Значение близко к нулю или ноль только при |x| < 10
    ...
    public static class CL00_99_2_log
    {
        ...
        {
#if DEBUG
            if (arg <= 0.0 || basis <= 0.0 || basis == 1.0)
                throw new Exception("Аргумент вне зоны определения");
#endif
    ...
    public static class CL00_100_3_log
    {
        ...
        {
#if DEBUG
            if (arg <= 0.0 || arg2 <= 0.0 || basis <= 0.0 || basis == 1.0)
                throw new Exception("Аргумент вне зоны определения");
#endif
    ...
    /// <param name="arg">Аргумент логарифма</param>
    /// <param name="basis">Основание логарифма a, необязаетльный параметр, из области (0, 1) & (1, w)</param>
    /// <param name="basis2">Основание логарифма b, необязаетльный параметр, из области (0, 1) & (1, w)</param>
    /// <returns>0</returns>
    [OpaqueFunction()]
    ...
    public static class CL00_103_3_log
    {
        ...
        {
#if DEBUG
            if (arg <= 0.0 || basis <= 0.0 || basis == 1.0 || basis2 <= 0.0 || basis2 == 1.0)
                throw new Exception("Аргумент вне зоны определения");
#endif
    ...
    {
        public static double L00_107_2_pow_exp(double arg, double param = 2.0)
        {
#if DEBUG
            if (param <= 0.0)
                throw new Exception("Аргумент вне зоны определения");
    ...
    {
        public static double L00_108_3_pow(double arg, double arg2, double param = 2.0)
        {
            double X, aX, aY, aXY;
            aX = Math.Pow(param, arg);
    ...
    {
        public static double L00_109_3_pow(double arg, double arg2, double param = 2.0)
        {
            double X, aX, aY, aXY;
            aX = Math.Pow(param, arg);
            aY = Math.Pow(param, arg2);
    ...
    {
        public static double L00_110_3_pow(double arg, double arg2, double param = 2.0)
        {
            double X, aX, axY, aXY;
            aX = Math.Pow(param, arg);
    ...
    public static class CL00_112_1_exp_ch_sh
    {
        ...
        {
#if DEBUG
            if (arg <= 0 || Math.Abs(arg - 2.12255012381007) <= Double.Epsilon)
                throw new Exception("Аргумент вне зоны определения");
#endif
            double X, ch, sh, exp;
            exp = Math.Exp(arg);
