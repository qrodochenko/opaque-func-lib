...
namespace SummerPractice_2016
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            MakeResultsSummaryFile("L00_101_3_log", CL00_101_3_log.L00_101_3_log, 5.0, 1, 100);//1w
            MakeResultsSummaryFile("L00_102_3_log", CL00_102_3_log.L00_102_3_log, 10, 5.0, 1, 100);//1w
            MakeResultsSummaryFile("L00_103_3_log", CL00_103_3_log.L00_103_3_log, 5.0, 10.0, 1, 100);//1w
            MakeResultsSummaryFile("L00_104_1_ln_arsh", CL00_104_1_ln_arsh.L00_104_1_ln_arsh);
            MakeResultsSummaryFile("L00_105_1_ln_arch", CL00_105_1_ln_arch.L00_105_1_ln_arch, 2, 100);//2w
            ...
            MakeResultsSummaryFile("L00_112_1_exp_ch_sh", CL00_112_1_exp_ch_sh.L00_112_1_exp_ch_sh, 1, 100);//1w
            MakeResultsSummaryFile("L00_113_1_ch_sh_th", CL00_113_1_ch_sh_th.L00_113_1_ch_sh_th, 1, 100);//1w
        ...
        static void makeErrorPlot(string source_csv_file_name)
        {
            ...
            while (!parser.EndOfData)
            {
               ...
               // if (fields[0] == 'символ бесконечности')
               // {
               //     fields[0] = "NaN";
               // }
